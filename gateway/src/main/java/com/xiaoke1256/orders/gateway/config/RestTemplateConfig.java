...
public class RestTemplateConfig {
     ...
     */
    @Bean
    @SentinelRestTemplate(blockHandler = "handleBlock", blockHandlerClass = SentinelBlockHandler.class,
                         fallback = "handleFallback", fallbackClass = SentinelBlockHandler.class)
