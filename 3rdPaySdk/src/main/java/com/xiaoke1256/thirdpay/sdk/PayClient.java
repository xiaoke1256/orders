...
public class PayClient {
    ...
    public static String generateOrderFormString(OrderInfo orderInfo, PrivateKey signKey) throws Exception {
        try( InputStream is = PayClient.class.getResourceAsStream("/cryptionkeys/public_key.pem")){
            return generateOrderFormString(orderInfo, signKey, RSAKeyPairGenerator.loadPublicKeyFromSt(is));
        }
